        ...
        if ($hospital_number == null) {
            ...
            if ($record_exist != null) {
                ...
                $request->validate([
                    ...
                    'doctor.comment' => 'max:700',
                    'nurse.rating' => 'required',
                    'nurse.comment' => 'max:700',
                    'midwife.rating' => 'required',
                    'midwife.comment' => 'max:700',
                    'security.rating' => 'required',
                    'security.comment' => 'max:700',
                    'radiology.rating' => 'required',
                    'radiology.comment' => 'max:700',
                    'pharmacy.rating' => 'required',
                    'pharmacy.comment' => 'max:700',
                    'laboratory.rating' => 'required',
                    'laboratory.comment' => 'max:700',
                    'admitting_staff.rating' => 'required',
                    'admitting_staff.comment' => 'max:700',
                    'medical_records.rating' => 'required',
                    'medical_records.comment' => 'max:700',
                    'billing.rating' => 'required',
                    'billing.comment' => 'max:700',
                    'cashier.rating' => 'required',
                    'cashier.comment' => 'max:700',
                    'social_worker.rating' => 'required',
                    'social_worker.comment' => 'max:700',
                    'food_server.rating' => 'required',
                    'food_server.comment' => 'max:700',
                    'janitors_orderly.rating' => 'required',
                    'janitors_orderly.comment' => 'max:700',
                    'q15.rating' => 'required',
                    'q16.rating' => 'required',
